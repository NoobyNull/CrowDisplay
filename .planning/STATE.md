...
2. **Add physical buttons rotary encoder and display function settings** (companion) -- map hardware buttons/encoder to actions, add clock/slideshow settings in companion editor
